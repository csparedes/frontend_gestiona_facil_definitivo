...
import 'package:gestionafacil_v3/utils/utils.dart';
...
class PdfInvoiceApi {
  ...
  static Widget buildCustomerAddress(Customer customer) => Column(
        ...
        children: [
          ...
          Text('Identificación: ' + customer.cedula,
              style: TextStyle(fontSize: 10)),
          Text('Domicilio: ' + customer.address),
        ],
      );
  ...
  static Widget buildInvoice(Invoice invoice) {
    final headers = ['Producto', 'Cantidad', 'Valor Unitario', 'Total'];
  ...
  static Widget buildFooter(Invoice invoice) => Column(
        ...
        children: [
          ...
          buildSimpleText(
              title: 'Ubicación: ',
              value:
                  'Tarqui 3-73 y Sucre, frente a la plazoleta del Mercado San Miguel'),
          SizedBox(height: 1 * PdfPageFormat.mm),
          buildSimpleText(title: '', value: 'Tulcán-Ecuador'),
        ],
      );
